...
/**
 * Autodromo Nazionale Monza — layout monza-7 (2000–present).
 * SVG asset: julesr0y/f1-circuits-svg (MIT) — public/circuits/monza-7.svg
 */
export const MONZA: CircuitDefinition = {
  id: "monza",
  layoutId: "monza-7",
  name: "Monza",
  ...
  landmarks: [],
  detectionPct: 76,
  overtakeZone: { startPct: 88, endPct: 98, label: "Overtake" },
  harvestZones: [
    { startPct: 4, endPct: 10, label: "T1 braking" },
    { startPct: 20, endPct: 26, label: "Roggia" },
    { startPct: 52, endPct: 60, label: "Ascari" },
    { startPct: 70, endPct: 78, label: "Parabolica" },
  ],
};
